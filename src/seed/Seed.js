...
const seedPhilosophers = () => {
    philosophers.forEach((philosopher) => {
        PhilosopherService.create(philosopher)
            ...
            .catch(err => Logger.log('info', `The following philosopher already exists: ${philosopher.name}`));
    })
};
...
const seedTopics = () => {
    topics.forEach((topic) => {
        TopicService.create(topic)
            ...
            .catch(err => Logger.log('info', `The following topic already exists: ${topic.text}`));
    })
};
...
const seedUsers = () => {
    users.forEach((user) => {
        UserService.create(user)
            ...
            .catch(err => Logger.log('info', `The following user already exists: ${topic.name}`));
    })
};
